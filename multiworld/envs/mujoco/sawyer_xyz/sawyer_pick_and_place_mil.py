...
class SawyerPickPlaceMILEnv(MultitaskEnv, SawyerXYZEnv):
    def __init__(
            self,
            xml_file=None,
            obj_low=None,
        ...
        if xml_file is None:
            self.model_name = get_asset_full_path('sawyer_xyz/sawyer_pick_and_place.xml')
        else:
            self.model_name = xml_file
        ...
        self.reset()
        print(self.get_obj_pos())
        print(self.data.get_body_xpos('distractor_0').copy())
    ...
    def _set_obj_xyz(self, pos, distractor=True):
